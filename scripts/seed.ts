...
const DEFAULT_SELECT_OPTIONS: Record<string, string[]> = {
  ...
  status: ['Продан', 'Склад', 'Отказ', 'Призрак'],
...
const DEFAULT_COLUMNS = [
  ...
  { key: 'j', label: 'Ж', type: 'number', default: '0', width: 80, order: 7 },
  { key: 'o', label: 'О', type: 'number', default: '0', width: 80, order: 8 },
  { key: 'k', label: 'К', type: 'number', default: '0', width: 80, order: 9 },
  { key: 'jok', label: 'ЖОК', type: 'number', default: '0', width: 100, order: 10 }, // computed = j + o + k
